...
The misclassification rate of the tree is .
...
```
    ...
    ## Variables actually used in tree construction:
    ## [1] "VisceraWeight" "Rings"         "WholeWeight"  
    ## Number of terminal nodes:  5 
    ## Residual mean deviance:  1.732 = 6502 / 3754 
    ## Misclassification error rate: 0.4613 = 1734 / 3759
...
The misclassification rate of the tree is 0.4612929.
...
The misclassification rate is 0.5047847.
...
The misclassification rate of the pruned tree is 0.5047847.
...
Mean cross-validation error for LDA is 0.4544048 and mean
cross-validation error for classification tree is 1. The
